...
void LCD::renderBG()
{
	uint32_t baseMem = memboy[LCDC] & 0x8 ? LCD_BG2_START : LCD_BG1_START;
...
void LCD::printChar(uint8_t charcode)
{
	uint32_t addr = memboy[LCDC] & 0x16 ? LCD_CHAR2_START : LCD_CHAR1_START;
